...
module "jenkins" {
  ...
  jenkins_controller_resources    = var.jenkins_controller_resources
  jenkins_agent_resources         = var.jenkins_agent_resources
  jenkins_controller_storage_size = var.jenkins_controller_storage_size
  tags                            = var.tags
}
